...
use OC\Bundle\BudgeBundle\Entity\Classe;
use OC\Bundle\BudgeBundle\Form\ClasseType;
...
class ClasseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OCBudgeBundle:Classe')->findAll();

        return $this->render('OCBudgeBundle:Classe:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('OCBudgeBundle:Classe:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OCBudgeBundle:Classe')->find($id);
        ...
        return $this->render('OCBudgeBundle:Classe:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('OCBudgeBundle:Classe:edit.html.twig', array(
            'entity'      => $entity,
