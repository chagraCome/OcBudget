...
use OC\Bundle\BudgeBundle\Entity\Contrat;
use OC\Bundle\BudgeBundle\Form\ContratType;
...
class ContratController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OCBudgeBundle:Contrat')->findAll();

        return $this->render('OCBudgeBundle:Contrat:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('OCBudgeBundle:Contrat:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OCBudgeBundle:Contrat')->find($id);
        ...
        return $this->render('OCBudgeBundle:Contrat:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('OCBudgeBundle:Contrat:edit.html.twig', array(
            'entity'      => $entity,
