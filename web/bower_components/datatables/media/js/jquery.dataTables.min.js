...
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Affichage _MENU_ par page",sLoadingRecords:"Loading...",sProcessing:"العمليّة جارية...",sSearch:"بحث :",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
